              ...
              <div className="antialiased text-white ">
                <div className="bg-gradient-to-b from-[#000F30] to-[#1c2e57] rounded-lg overflow-hidden shadow-2xl  group overflow-hidden transition-transform duration-300 hover:translate-y-[-10px]">
                  ...
                  <div className="p-6 pb-4 group-hover:bg-gradient-to-b from-[# 3b4765] to-[#182033] duration-[0.3s]">
                    <h4 className="mt-1 font-semibold text-xl leading-tight truncate group-hover:text-blue-600 duration-[0.3s]">{post.title}</h4>
                    <p className="Card-info text-gray-300 font-light text-sm mt-2 group-hover:text-blue-400">
                    ...
                    <div className="mt-4 flex items-center">
                      ...
                      <div className="ml-3">
                        <p className="text-sm font-medium text-white">
                          <a href="#" className="hover:text-blue-600 group-hover:text-blue-600 duration-[0.3s]">Phelipe Curty</a>
                        </p>
